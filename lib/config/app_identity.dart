abstract final class AppIdentity {
  ...
  static const splashRevealDuration = Duration(milliseconds: 900);
  static const version = '1.0.0+1';

  // Cette mention décrit la conception de l’outil. Elle ne constitue pas
  // une attribution institutionnelle ni une validation officielle.
  static const designerCredit =
      'Outil conçu par Marc Bouyssou, '
      'vice-président de l’URPS MK Nouvelle-Aquitaine';
}
