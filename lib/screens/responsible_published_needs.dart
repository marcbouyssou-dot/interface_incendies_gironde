...
class ResponsiblePublishedNeeds extends ValueNotifier<List<CoordinationNeed>> {
  ResponsiblePublishedNeeds() : super(const []);
  ...
  void _reconcileAfterFrame(Set<String> acknowledged) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (_disposed) return;
      if (_pendingAcknowledgements.isEmpty) return;
